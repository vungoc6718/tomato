...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-primary"> Sửa Điểm Danh</h6>
	</div>
	<div class="card-body">
		<?php
				...
				if(isset($_POST['edit_btn']))
				{
					...
					foreach ($query_run as $row) 
					{
						...
						<form action="diem_danh_codetc.php" method="POST">
							...
							<a href="diem_danhtc.php" class="btn btn-danger"> CANCEL </a>	
						</form>
						<?php 
					}
				}	
