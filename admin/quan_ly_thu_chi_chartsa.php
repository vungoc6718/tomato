...
<div class="card shadow mb-4">
  <div class="card-header py-3"> 
      <form action="quan_ly_thu_chi_ngaysa.php" method="POST">   
      <a class="btn btn-info"  href="quan_ly_thu_chi_viewsa.php" >Back</a> 
      ...
      <?php 
       ...
       <br>
       <form action="quan_ly_thu_chi_pdfsa.php" method="POST">   
      <?php 
        if(isset($_POST['chart']))
        {
