...
<div class="modal fade" id="addadminprofile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="hoc_sinh_codesa.php" method="POST">
          ...
          while ($row=$result->fetch_assoc()) 
          {
            ...
            <tr>
                  ...
                  <td> <?php echo $row['Lop']; ?> </td>
                   <td>
                    <form action="hientt_phsa.php" method="POST">
                          <input type="hidden" name="ma_ph" value="<?php echo $row['MaPH']; ?>" >
                          <button type="submit" name="hienph" class="btn btn-success"> <?php echo $row['MaPH']; ?> </button>                        
                      </form>
                 </td>
                  ...
                  <td>
                      <form action="hoc_sinh_editsa.php" method="POST">
