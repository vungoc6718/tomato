...
if(isset($_POST['xuat_phieu_thu'])){
  ...
  $id =$_POST['id_thu'];
    ...
    $query ="SELECT thu_tien_hoc.id,MaThu,thu_tien_hoc.NgayThang,hoc_sinh.MaHocSinh,TenHocSinh,SoTien,NoiDung,NguoiThu,TenNhanVien,hoc_sinh.NgaySinh,Lop,MaPH, SDT,hoc_sinh.DiaChi 
              FROM thu_tien_hoc 
