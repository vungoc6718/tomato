...
<div class="card shadow mb-4">
  <div class="card-header py-3">
      ...
      <a class="btn btn-info"  href="diem_danh_lop.php" >Back</a>
 	    <?php 
    ...
    <div class="card-body">
        ...
        if(isset($_POST['ma_hs_id']))
        {
          ...
          if ($row=mysqli_fetch_array($query_run)) 
          {
            ...
            <label>Phụ Huynh: <?php echo $row['PhuHuynh']; ?> </label> <br>
            <label>Số Điện Thoại: <?php echo $row['PhuHuynh_Sdt']; ?> </label>   <br>                  
